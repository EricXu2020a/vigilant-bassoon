...
public class StartPanel extends JPanel
{
	...
	public StartPanel(CelebrityGame controller)
	{
		...
		this.carRadio = new JRadioButton("Famous Cars");
		...
		this.carClue = "Enter logo description and country of origin (separated by commas)";
		this.clueLabel = new JLabel(celebrityClue);
		
		this.answerField = new JTextField("Type celebrity here (5 letters minimum thx Cher)");
		this.clueField = new JTextField("Enter celebrity clue here (5 letters minimum)");
	...
	private boolean validate(String answerText, String clueText)
	{
		...
		{
			validClue = controller.validateClue(clueText, "Famous Cars");
		}
	...
	private void setupLayout()
	{
		...
		panelLayout.putConstraint(SpringLayout.NORTH, literatureRadio, 10, SpringLayout.SOUTH, carRadio);
		panelLayout.putConstraint(SpringLayout.WEST, literatureRadio, 0, SpringLayout.WEST, celebrityRadio);
		panelLayout.putConstraint(SpringLayout.WEST, carRadio, 0, SpringLayout.WEST, celebrityRadio);
		panelLayout.putConstraint(SpringLayout.NORTH, carRadio, 10, SpringLayout.SOUTH, celebrityRadio);
	...
	private void setupListeners()
	{
		...
		carRadio.addActionListener(select -> clueLabel.setText(carClue));
