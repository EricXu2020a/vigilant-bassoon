...
public class CalculatorProgram {
    ...
    private CalculatorProgram() {
        window = new JFrame("CalculatorProgram");
        ...
        btnSwitchToScientificMode.setBounds(25, 30, 350, 18);
        btnSwitchToScientificMode.setText("Scientific Operations");
        btnSwitchToScientificMode.setBackground(Color.BLUE.darker());
        btnSwitchToScientificMode.setForeground(Color.BLACK);
        ...
        inText.setBounds(x[0], y[0], 360, 70);
        ...
        btnEqual.setBounds(x[2], y[5], 2 * BUTTON_WIDTH, BUTTON_HEIGHT);
