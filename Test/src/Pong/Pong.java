...
public class Pong extends Canvas implements KeyListener, Runnable
{
	...
	public Pong()
	{
		ball = new SpeedUpBall(300, 300, 10, 10, Color.magenta, 1, 1);
		leftPaddle = new Paddle(40, 200, 10, 100, Color.PINK, 3);
		rightPaddle = new Paddle(730, 200, 10, 100, Color.orange, 3);
